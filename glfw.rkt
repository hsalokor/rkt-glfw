...
(define-ffi-functions (ffi-lib "libglfw")
  ...
  (glfwGetMonitorPos                  ((monitor : _pointer) (xpos : (_ptr o _int)) (ypos : (_ptr o _int)) -> _void))
  (glfwGetMonitorPhysicalSize         ((monitor : _pointer) (widthMM : (_ptr o _int)) (heightMM : (_ptr o _int)) -> _void))
  ...
  (glfwGetWindowPos                   ((window : _pointer) (xpos : (_ptr o _int)) (ypos : (_ptr o _int)) -> _void))
  (glfwSetWindowPos                   ((window : _pointer) (xpos : _int) (ypos : _int) -> _void))
  (glfwGetWindowSize                  ((window : _pointer) (width : (_ptr o _int)) (height : (_ptr o _int)) -> _void))
  ...
  (glfwGetFramebufferSize             ((window : _pointer) (width : (_ptr o _int)) (height : (_ptr o _int)) -> _void))
  (glfwGetWindowFrameSize             ((window : _pointer) (left : (_ptr o _int)) (top : (_ptr o _int)) (right : (_ptr o _int)) (bottom : (_ptr o _int)) -> _void))
  ...
  (glfwGetCursorPos                   ((window : _pointer) (xpos : (_ptr o _double)) (ypos : (_ptr o _double)) -> _void))
