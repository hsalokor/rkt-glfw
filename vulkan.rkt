...
(define-ffi-functions (ffi-lib "glfw3")
  ...
  (glfwCreateWindowSurface                      ((instance : _VkInstance) (window : _pointer) (allocator : _VkAllocationCallbacks-pointer/null) (surface : (_ptr o _VkSurfaceKHR)) -> (result : _VkResult) -> (values result surface))))
